...
modstitch {
    ...
    metadata {
        modId = "releasemouse"
        modName = "Release Mouse"
        modVersion = "0.0.0"
        modGroup = "je.mods.releasemouse"
        modAuthor = "r_Jerry_"
        modLicense = "CC0-1.0"
        modDescription = """
            NeoForge也要释放鼠标😡
...
dependencies {
    modstitch.loom {/*
        ...
        modstitchModImplementation("net.fabricmc.fabric-api:fabric-api:0.77.0+1.18.2")*/
